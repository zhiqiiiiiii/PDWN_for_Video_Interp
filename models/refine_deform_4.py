...
class UNet(nn.Module):
    def __init__(self, in_ch, kernel=2, groups=1, num_input_frames=2, num_output_frames=1, 
                 interpolation=False, context=False):
        ...
        self.up2   = up(256+128+128++128+128+81+self.offset_channels, 196)
        self.up3   = up(196+96+96++96+96+81+self.offset_channels, 128)
        self.up4   = up(128+64+64+64+64+81+self.offset_channels, 96)
        self.up5   = up(96+32+32+32+32+81+self.offset_channels, 64)
        self.up6   = nn.Sequential(
                     nn.Conv2d(in_channels=64+16+16+16+16+81+self.offset_channels, 
    ...
    def forward(self, input_frames, num_input_frames=2, num_output_frames=1, use_cuda=False):
        ...
        I2 = input_frames[:,:, 2, :, :].contiguous()
        I3 = input_frames[:,:, 3, :, :].contiguous()
        ...
        feat4_1_warped = self.deform4_0(feat4_1.contiguous(), offset_0)
        feat4_2_warped = self.deform4_1(feat4_2.contiguous(), offset_1)
        ...
        feat3_1_warped = self.deform3_0(feat3_1.contiguous(), offset_0)
        feat3_2_warped = self.deform3_1(feat3_2.contiguous(), offset_1)
        ...
        feat2_1_warped = self.deform2_0(feat2_1.contiguous(), offset_0)
        feat2_2_warped = self.deform2_1(feat2_2.contiguous(), offset_1)
        ...
        feat1_1_warped = self.deform1_0(feat1_1.contiguous(), offset_0)
        feat1_2_warped = self.deform1_1(feat1_2.contiguous(), offset_1)
        ...
        feat0_1_warped = self.deform0_0(feat0_1.contiguous(), offset_0)
        feat0_2_warped = self.deform0_1(feat0_2.contiguous(), offset_1)
        ...
        I1_warped = self.deform_0(I1, offset_0)
        I2_warped = self.deform_1(I2, offset_1)
        feat0_1_warped = self.deform_feat_0(feat0_1, offset_0)
        feat0_2_warped = self.deform_feat_1(feat0_2, offset_1)
